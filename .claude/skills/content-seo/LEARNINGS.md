...
## What works
- Title without brand duplication: Layout appends `- CallLine` automatically, so pass page title without "AstroDeck" → clean `<title>` tag (2026-03-15)
...
- Title duplication "AstroDeck ... - CallLine" — happens when page title already contains the brand name and the layout appends `- CallLine` again (2026-03-15)
